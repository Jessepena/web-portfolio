...
function CustomPopover() {
	...
	return (
		<Popover>
			...
			>
				<Popover.Panel className="absolute z-10 inset-x-8 top-8 rounded-lg bg-background dark:border dark:border-gray-700 dark:bg-background-dark divide-y divide-gray-200 dark:divide-gray-700">
					...
					{links.map((link) => (
						<Popover.Button
							...
							key={link.label}
							href={link.route}
							className="block px-4 py-3 divide-y divide-gray-200 dark:divide-gray-700"
						>
							{link.label}
						</Popover.Button>
					))}
